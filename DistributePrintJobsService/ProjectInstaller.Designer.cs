...
namespace DistributePrintJobsService
{
    partial class ProjectInstaller
    {
        ...
        private void InitializeComponent()
        {
            ...
            // TheServiceInstaller
            // 
            this.TheServiceInstaller.Description = "Allows manual distribution of print jobs.";
            this.TheServiceInstaller.DisplayName = "DistributePrintJobs";
            this.TheServiceInstaller.ServiceName = "DistributePrintJobs";
